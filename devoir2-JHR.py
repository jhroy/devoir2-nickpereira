...
if req.status_code == 200:
    ...
    code = req.json()
    for numero in code["registre"]:
        # numero = ["comlog_id"] ### PREMIER PROBLÈME -> ICI, TU ÉCRASE LA VARIABLE "NUMERO"...
        ### TU VEUX PLUTÔT ÉCRIRE:
        num = numero[0]["client_org_corp_num"]
        clientan = numero[0]["en_client_org_corp_nm"] ### ET AINSI DE SUITE
        clientfr = ["fr_client_org_corp_nm"]
        date = ["date_comm"]
        sujet = ["objet"]
        sujet2 = ["objet_autre"]
        institution = ["institution"]
        print(num, clientan, clientfr, date, sujet, sujet2, institution)
...
### VOLONTIERS :)
### BIEN QUE TON SCRIPT NE PRODUISE PAS LE CSV DEMANDÉ, LA RICHESSE DE TES COMMENTAIRES ME POUSSE À TE DONNE UN A-